...
const Texteditor = () => {
  ...
  const handleSave = async () => {
    ...
    if (res.data.message === "1") toast.success("Blog Updated Succesfully");
    else if (res.data.message === "0") toast.success("Blog Added Successfully");
    else if (res.data.message === "-1") toast.error("Connection Error");
  };
  ...
  return (
    <>
      ...
      <select
        ref={selectVal}
        class="form-select form-select-sm mb-3 bg-dark text-white "
